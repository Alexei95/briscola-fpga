...
#set_property PACKAGE_PIN T8 [get_ports {turn}]
...
#set_property PACKAGE_PIN K5 [get_ports red1_out]
#set_property IOSTANDARD LVCMOS33 [get_ports red1_out]
##Bank = 15, Pin name = IO_L5P_T0_AD9P_15,					Sch name = LED16_G
#set_property PACKAGE_PIN F13 [get_ports green1_out]
#set_property IOSTANDARD LVCMOS33 [get_ports green1_out]
##Bank = 35, Pin name = IO_L19N_T3_VREF_35,					Sch name = LED16_B
#set_property PACKAGE_PIN F6 [get_ports blue1_out]
#set_property IOSTANDARD LVCMOS33 [get_ports blue1_out]
##Bank = 34, Pin name = IO_0_34,								Sch name = LED17_R
#set_property PACKAGE_PIN K6 [get_ports red2_out]
#set_property IOSTANDARD LVCMOS33 [get_ports red2_out]
##Bank = 35, Pin name = IO_24P_T3_35,						Sch name =  LED17_G
#set_property PACKAGE_PIN H6 [get_ports green2_out]
#set_property IOSTANDARD LVCMOS33 [get_ports green2_out]
##Bank = CONFIG, Pin name = IO_L3N_T0_DQS_EMCCLK_14,			Sch name = LED17_B
#set_property PACKAGE_PIN L16 [get_ports blue2_out]
#set_property IOSTANDARD LVCMOS33 [get_ports blue2_out]



##7 segment display
##Bank = 34, Pin name = IO_L2N_T0_34,						Sch name = CA
#set_property PACKAGE_PIN L3 [get_ports {disp_out[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {disp_out[0]}]
##Bank = 34, Pin name = IO_L3N_T0_DQS_34,					Sch name = CB
#set_property PACKAGE_PIN N1 [get_ports {disp_out[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {disp_out[1]}]
##Bank = 34, Pin name = IO_L6N_T0_VREF_34,					Sch name = CC
#set_property PACKAGE_PIN L5 [get_ports {disp_out[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {disp_out[2]}]
##Bank = 34, Pin name = IO_L5N_T0_34,						Sch name = CD
#set_property PACKAGE_PIN L4 [get_ports {disp_out[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {disp_out[3]}]
##Bank = 34, Pin name = IO_L2P_T0_34,						Sch name = CE
#set_property PACKAGE_PIN K3 [get_ports {disp_out[4]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {disp_out[4]}]
##Bank = 34, Pin name = IO_L4N_T0_34,						Sch name = CF
#set_property PACKAGE_PIN M2 [get_ports {disp_out[5]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {disp_out[5]}]
##Bank = 34, Pin name = IO_L6P_T0_34,						Sch name = CG
#set_property PACKAGE_PIN L6 [get_ports {disp_out[6]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {disp_out[6]}]

##Bank = 34, Pin name = IO_L16P_T2_34,						Sch name = DP
#set_property PACKAGE_PIN M4 [get_ports {disp_out[7]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {disp_out[7]}]

##Bank = 34, Pin name = IO_L18N_T2_34,						Sch name = AN0
#set_property PACKAGE_PIN N6 [get_ports {disp_an_out[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {disp_an_out[0]}]
##Bank = 34, Pin name = IO_L18P_T2_34,						Sch name = AN1
#set_property PACKAGE_PIN M6 [get_ports {disp_an_out[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {disp_an_out[1]}]
##Bank = 34, Pin name = IO_L4P_T0_34,						Sch name = AN2
#set_property PACKAGE_PIN M3 [get_ports {disp_an_out[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {disp_an_out[2]}]
##Bank = 34, Pin name = IO_L13_T2_MRCC_34,					Sch name = AN3
#set_property PACKAGE_PIN N5 [get_ports {disp_an_out[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {disp_an_out[3]}]
##Bank = 34, Pin name = IO_L3P_T0_DQS_34,					Sch name = AN4
#set_property PACKAGE_PIN N2 [get_ports {disp_an_out[4]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {disp_an_out[4]}]
##Bank = 34, Pin name = IO_L16N_T2_34,						Sch name = AN5
#set_property PACKAGE_PIN N4 [get_ports {disp_an_out[5]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {disp_an_out[5]}]
##Bank = 34, Pin name = IO_L1P_T0_34,						Sch name = AN6
#set_property PACKAGE_PIN L1 [get_ports {disp_an_out[6]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {disp_an_out[6]}]
##Bank = 34, Pin name = IO_L1N_T034,							Sch name = AN7
#set_property PACKAGE_PIN M1 [get_ports {disp_an_out[7]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {disp_an_out[7]}]
...
#set_property PACKAGE_PIN F15 [get_ports btnApply]
#set_property IOSTANDARD LVCMOS33 [get_ports btnApply]
##Bank = CONFIG, Pin name = IO_L15N_T2_DQS_DOUT_CSO_B_14,	Sch name = BTNL
#set_property PACKAGE_PIN T16 [get_ports btnR]
#set_property IOSTANDARD LVCMOS33 [get_ports btnR]
##Bank = 14, Pin name = IO_25_14,							Sch name = BTNR
#set_property PACKAGE_PIN R10 [get_ports btnB]
#set_property IOSTANDARD LVCMOS33 [get_ports btnB]
##Bank = 14, Pin name = IO_L21P_T3_DQS_14,					Sch name = BTND
#set_property PACKAGE_PIN V10 [get_ports btnG]
#set_property IOSTANDARD LVCMOS33 [get_ports btnG]
