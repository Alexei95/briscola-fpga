...
HD_PWD='C:/Users/colucci/Google Drive/Uni/Second Year - 2015_2016/Second Semester/Computer Architecture/Assignment/2016/Project_personal/briscola/briscola.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Briscola.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Briscola.tcl -notrace
