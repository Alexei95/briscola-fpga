...
HD_PWD='C:/Users/colucci/Google Drive/Uni/Second Year - 2015_2016/Second Semester/Computer Architecture/Assignment/2016/Project_personal/briscola/briscola.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Briscola.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Briscola.tcl
